...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.AkuManga = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const AM_DOMAIN = 'https://akumanga.com';
class AkuManga extends paperback_extensions_common_1.Source {
    constructor(cheerio) {
        super(cheerio);
    }
    get version() { return '0.1.0'; }
    get name() { return 'AkuManga'; }
    get description() { return 'موقع ترجمة المانجا العربية'; }
    get author() { return 'Conrad Weiser'; }
    get authorWebsite() { return 'https://github.com/conradweiser'; }
    get icon() { return "logo.png"; }
    get hentaiSource() { return false; }
    getMangaShareUrl(mangaId) { return `${AM_DOMAIN}/manga/${mangaId}`; }
    get sourceTags() { return [{ text: "Arabic", type: paperback_extensions_common_1.TagType.GREY }]; }
    get rateLimit() {
        return 2;
    }
    get websiteBaseURL() { return AM_DOMAIN; }
    getMangaDetailsRequest(ids) {
        let requests = [];
        for (let id of ids) {
            let metadata = { 'id': id };
    ...
    getMangaDetails(data, metadata) {
        ...
        let rating = (_a = Number($('span.total_votes', $('div.post-total-rating')).text())) !== null && _a !== void 0 ? _a : 0;
        let author, artist;
        let i = 0;
    ...
    getChapters(data, metadata) {
        ...
        for (let obj of $('ul.version-chap', $('div.page-content-listing')).toArray()) {
            let id = (_a = $('a', $('li.wp-manga-chapter', $(obj))).attr('href')) === null || _a === void 0 ? void 0 : _a.replace(/\D/g, '');
            ...
            for (let i = 1; i <= Number(id); i++) {
                chapters.push(createChapter({
                    ...
                    mangaId: metadata.id,
                    chapNum: i,
                    langCode: paperback_extensions_common_1.LanguageCode.UNKNOWN // Are we missing an arabic language code?
                }));
            }
        }
        return chapters;
